...
class BlogPostTest < ActiveSupport::TestCase
  ...
  test "draft? returns true for published blog_post" do 
    refute blog_posts(:published).draft?  
  end

  test "draft? returns true for scheduled blog_post" do 
  ...
  test "scheduled? returns false for scheduled blog_post" do 
